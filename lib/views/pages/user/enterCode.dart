...
//   void initState() {
//     getCurrentUser();
//     Users = inU.userPageVM.getUserRequests("Approved");
//     super.initState();
//   }
//
//   @override
...
//                     }
//                   }
//                   ProspectiveUsers = inU.prospectiveUserPageVM
//                       .getProspectiveUserRequests(userType);
//                   prospectiveList = await ProspectiveUsers;
//                   if (prospectiveList.length != 0) {
//                     for (var puser in prospectiveList) {
//                       if (puser.userEmail == email &&
//                           puser.inviteCode == _textController.text) {
//                         if (puser.inviteType == 'local_admin') {
//                           userrequest.email = email;
//                           userrequest.roleId = 2;
//                           String userrequestStr =
...
//                               jsonEncode(prospectiveUserRequest.toStrJson());
//                           inU.prospectiveUserPageVM
//                               .submitUpdateProspectiveUserRequest(
//                                   prospectiveStr);
//                           SnackBar mysnackbar = SnackBar(
